...
const DisplayCard2 = (props: DisplayCard2Props) => {
  let { title, desc, topBtn, button, imgRight } = props;
  return (
    <DisplayCard2.Wrapper button={button} imgRight={imgRight}>
    ...
    </DisplayCard2.Wrapper>
  );
};

DisplayCard2.Wrapper = styled.div<DisplayCard2Props>`
  width: 100%;
  height: fit-content;
  border-radius: 30px;
  background: #090909;
